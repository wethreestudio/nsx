...
objJsIncludes.Add "tablesorter", "/js/jquery.tablesorter.js"
...
Filter Securities: 
<a href="prices_alpha.asp?nsxcode=&amp;region=<%=displayboard%>"  >All</a> | 
<a href="prices_alpha.asp?nsxcode=&amp;traded=1" >Traded Today</a>&nbsp;
Sector: <a href="prices_alpha.asp?nsxcode=&amp;board=ncrp&amp;region=<%=displayboard%>" >Industrial</a> | 
<a href="prices_alpha.asp?nsxcode=&amp;board=nprp&amp;region=<%=displayboard%>" >Property</a> | 
<a href="prices_alpha.asp?nsxcode=&amp;board=ndbt&amp;region=<%=displayboard%>" >Debt</a> |
<a href="prices_alpha.asp?nsxcode=&amp;board=nmin" >Mining &amp; Energy</a> |
<a href="prices_alpha.asp?nsxcode=&amp;board=nrst" >Restricted</a>
<br>Certficated Securities: 
		<a href="prices_alpha.asp?nsxcode=&amp;currentpage=1&amp;board=comm&amp;region=" class="rhlinks">Community Banks</a> |
		<a href="prices_alpha.asp?nsxcode=&amp;currentpage=1&amp;board=main&amp;region=" class="rhlinks">Industrial</a> |
		<a href="prices_alpha.asp?nsxcode=&amp;currentpage=1&amp;board=prop&amp;region=" class="rhlinks">Property</a> 
...
Else
  While Not rs.EOF
    ...
    End If		
		...
		if status2 <> "" then
			status = "<a href=""/marketdata/search_by_company?nsxcode=" & rs("tradingcode") & "&amp;region=" & displayboard & """ title='See news on this company'>" & status2 & "</a>&nbsp;" 
		end if
...
%>                     	 
<tr> 
    <td><a href="/summary/<%=UCase(rs("tradingcode"))%>"><%=rs("tradingcode")%></a></td> 
...
<li>Press <b>Shift</b> key while clicking headings to sort using multiple columns.</li>
<li>Price information on this page is delayed.</li>
<li>Explanations for data can be found on the <a href="prices_definitions.asp?region=">Full Definitions</a> page.
<li>If a security has never traded then the last price is the IPO price.</li>
</ol>
</div>
