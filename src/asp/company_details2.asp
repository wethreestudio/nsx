...
%>	<img src="/images/company_images/<%=agLogo%>" alt="Logo - <%=remcrlf(ucase(coname))%>">
<% 
End If
%>
...
<tbody> 
  ...
  <tr <%=trClass()%>>
    ...
    <td align="left" valign="top">
    <%
    if len(trim(agweb0))>0 then response.write "<a href=""" & agweb0 &""" target=""_blank"">" & Replace(agweb0,"http://","",1,1) & "</a><br>"
    if len(trim(agweb1))>0 then response.write "<a href=""" & agweb1 &""" target=""_blank"">" & Replace(agweb1,"http://","",1,1) & "</a><br>"
    if len(trim(agweb2))>0 then response.write "<a href=""" & agweb2 &""" target=""_blank"">" & Replace(agweb2,"http://","",1,1) & "</a><br>"
    if len(trim(agweb3))>0 then response.write "<a href=""" & agweb3 &""" target=""_blank"">" & Replace(agweb3,"http://","",1,1) & "</a><br>"
    if len(trim(agweb4))>0 then response.write "<a href=""" & agweb4 &""" target=""_blank"">" & Replace(agweb4,"http://","",1,1) & "</a><br>"
    if len(trim(agweb5))>0 then response.write "<a href=""" & agweb5 &""" target=""_blank"">" & Replace(agweb5,"http://","",1,1) & "</a><br>"
    if len(trim(agweb6))>0 then response.write "<a href=""" & agweb6 &""" target=""_blank"">" & Replace(agweb6,"http://","",1,1) & "</a><br>"
    if len(trim(agweb7))>0 then response.write "<a href=""" & agweb7 &""" target=""_blank"">" & Replace(agweb7,"http://","",1,1) & "</a><br>"
    if len(trim(agweb8))>0 then response.write "<a href=""" & agweb8 &""" target=""_blank"">" & Replace(agweb8,"http://","",1,1) & "</a><br>"
    if len(trim(agweb9))>0 then response.write "<a href=""" & agweb9 &""" target=""_blank"">" & Replace(agweb9,"http://","",1,1) & "</a><br>"
    %>
    </td>
  </tr>
  <%end if%>
