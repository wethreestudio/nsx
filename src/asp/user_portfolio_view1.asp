...
If rs.EOF Then
  %><p>You don't currently have any securities in your portfolio. <a href="user_portfolio_edit1.asp">Click here</a> to add securities to your portfolio.<%
Else
%>
...
%>
      ...
      <div style="width:100%;padding-top:15px;text-align:right;">
        <input type="button" name="edit" value="Edit Portfolio &amp; Alerts" onclick="window.location.href='user_portfolio_edit1.asp?portfolioname=default'" />
      </div>
<%
End If
%>
