...
SQL = "SELECT TOP 8 id,newsdate,newstitle,newsprecise  FROM news ORDER BY NewsDate DESC"
CmdDD.CacheSize=100
...
<% else
  ...
  <tr bgcolor="<%=cl(lap)%>" onMouseOver="this.bgColor='#CCCCDD'" onmouseout="this.bgColor='<%=cl(lap)%>'">
       <td width="100%" class="plaintext" valign="top" ><a href=<%="news_view.asp?ID=" & ID%> target=_blank>
	<font size="1">
