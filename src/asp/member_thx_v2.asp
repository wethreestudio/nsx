...
<div class="table-responsive"><table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="100%" class="textheader" bgcolor="#FFFFFF" >
		...
		<h1><b><font face="Arial">FORGOTTEN
      PASSWORD</font></b></h1>
  ...
  <tr>
    <td width="700" class="plaintext" valign="top" bgcolor="#FFFFFF">
    
    

	<p align="left">&nbsp;We have just sent your password to your notified e-mail 
	address.</p>
