...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <h1>NSX NOMINATED ADVISER CONTACT SHEET</h1>
...
SQL = "SELECT adid,adName,Address,POBOX,AdEmail,Websites,Logo,Strapline,Phone,Fax FROM shaden ORDER BY adName ASC "
'SQL = SQL & srch 
