...
SQL = "SELECT usubscribers.* FROM usubscribers WHERE (username = '" & SafeSqlParameter(session("username")) & "')"
...
if ORG="" THEN
CmdEditUser.Fields("organisation") = "User MyNSX"
Else
CmdEditUser.Fields("organisation") = "User MyNSX"
END IF
...
Response.Redirect "user_edit_your_details.asp"%>