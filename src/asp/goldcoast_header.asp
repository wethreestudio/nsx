...
//-->
 ...
 <div align="center">
   <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" id="table1" bgcolor="#FFFFFF">
     <tr>
       <td bgcolor="#959CA0" >
    <p align="right"><a class="bodylinks" href="GoldCoast_Default.asp">Gold Coast Home</a> 
	<font color="#FFFFFF">|</font>
    <a class="bodylinks" href="contacts.asp?region=GCX">Contact Us</a> 
	<font color="#FFFFFF">|</font>&nbsp;
    <a class="bodylinks" a href="#" onclick="javascript:window.print();">Print</a> 
	<font color="#FFFFFF">|</font> <a class="bodylinks" href="whatis_rss.asp?region=GCX">RSS</a> &nbsp; </td>
     </tr>
     <tr>
     <%
    ...
    <img border="0" src="images/NSX-LOGOx150.gif" width="150" height="37" title="NSX Home" align="middle"></a><a target="_blank" href="http://www.businessgrowthgc.com.au"><img border="0" src="GoldCoast/images/gcbclogo02.gif" width="118" height="20" align="middle"></a></td>
     </tr>
     <tr>
