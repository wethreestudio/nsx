...
&nbsp;</font></td>
  ...
  <tr>
    ...
    <font color="#FFFFFF" size="1">&nbsp;Port Moresby Stock Exchange ("POMSoX")  
    <%
        daylight = Application("nsx_daylight_saving")
    if daylight then
    	response.write " | <a href=# class=bodylinks title='PNG Daylight Saving Time'>PDST</a>"
    	else
    	response.write " | <a href=# class=bodylinks title='PNG Standard Time'>PST</a>"
    end if
    %>
