...
<div class="table-responsive"><table cellspacing=0 border="0" width="165" id="table100" cellpadding="5" >
	<tr>
		<td class=plaintext bgcolor=#959CA0><font color="#FFFFFF"><b>Declines</b></font></td>
...
ELSE
  ...
  <tr bgcolor="<%=cl(lap)%>" onMouseOver="this.bgColor='#CCCCDD'" onmouseout="this.bgColor='<%=cl(lap)%>'">
		...
		<td class=plaintext >
		<p align="right"><font size="1"><%=formatnumber(last,3)%></font></td>
		<td class=plaintext align=right><font size="1" color=red><%=formatnumber(-diff,2)%></font></td>
	</tr>
