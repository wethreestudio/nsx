...
<div class="editarea">
    <div style="width:100%;text-align:middle">
        Filter Securities:
        <a href="prices_alpha.asp">All</a> | 
        <a href="prices_alpha.asp?traded=1" >Traded Today</a>&nbsp;
        Sector: <a href="prices_alpha.asp?nsxcode=&board=ncrp" >Industrial</a> | 
        <a href="prices_alpha.asp?nsxcode=&board=nprp">Property</a> | 
        <a href="prices_alpha.asp?nsxcode=&board=ndbt">Debt</a> |
        ...
        <a href="prices_alpha.asp?nsxcode=&currentpage=1&board=comm" class="rhlinks">Community Banks</a> |
        <a href="prices_alpha.asp?nsxcode=&currentpage=1&board=main" class="rhlinks">Industrial</a> |
        <a href="prices_alpha.asp?nsxcode=&currentpage=1&board=prop" class="rhlinks">Property</a>
        </div>
...
%>                     	 
<tr> 
	<td><a href="/marketdata/company-directory/<%=rs("tradingcode")%>/" title="Click for more detail. <%=rs("issuedescription")%>"><%=rs("tradingcode")%></a></td> 
...
<div>
    ...
    <%
    PrintSearchBox "", "company", "", "Enter company name or code", ""
    %>
    <hr>
    <h2>By Sector</h2>
    <ul>
