...
%>
  ...
  <tr>
    ...
    <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=1"&group=<%=group%>>First</a> | 
    <b>
    <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=currentpage-1%>&group=<%=group%>">
	<font size="3">&lt;&lt;</font></b><b>
      ...
      %>
      <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=ii%>&group=<%=group%>" ><%=ii%></a> | 
      ...
      <%if maxpages > CurrentPage then %>
             ...
             <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=currentpage+1%>&group=<%=group%>">Next <%=maxpagesize%> </a>
    <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=currentpage-1%>&group=<%=group%>">
...
<p align="left"><b>Pages</b>: <%if currentpage > 1 then %>
    <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=1">First</a> | 
    <b>
    <a href="announcements_status_v2.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=currentpage-1%>">
	<font size="3">&lt;&lt;</font></b><b>
	</b>Previous <%=maxpagesize%></a> | 
            <%end if%>
