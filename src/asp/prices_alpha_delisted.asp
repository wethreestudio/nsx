...
<p>Securities: <a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>" >All</a> | 
<a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>&board=ncrp" >
Industrial</a> | <a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>&board=nprp" >Property</a> | <a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>&board=ndbt" >Debt</a> 
|
<a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>&board=nmin" >
Mining &amp; Energy</a> |
<a href="prices_alpha.asp?nsxcode=<%=tradingcodes%>&currentpage=<%=currentpage%>&board=nrst" >
Restricted</a><br>
<%end if%>	
...
<table id="prices_123" cellpadding=1 class="sortable" cellspacing="1" width="100%" bgcolor="#FFFFFF" style="border-bottom:1px solid #808080; ">
  ...
  <tr bgcolor="<%=cl(lap)%>" onMouseOver="this.bgColor='#CCCCDD'" onmouseout="this.bgColor='<%=cl(lap)%>'">
    <td class="plaintext" nowrap align=left valign="middle"><font color="<%=col3%>"><a href="prices_alpha.asp?nsxcode=<%=tradingcode %>" title="click here to see full depth for <%=tradingcode & ": " & issuedescription %>"><%=tradingcode %></a></font></td>
...
<tr>
    ...
    <td bgcolor="<%=cl(lap)%>" align=left class="plaintext" valign=top>&nbsp;</td>
     ...
     <td bgcolor="#CCFFFF"  class="plaintext" align="right" valign="top" width="93" ><%
     bb = split(bidorders,"|")
     bbcount = ubound(bb)
     for ii = 0 to bbcount
     ...
     next
     %>&nbsp;</td>
     <td bgcolor="#CCFFFF" class="plaintext" align="right" valign="top" width="94"><%
     bb = split(bidprices,"|")
     bbcount = ubound(bb)
     for ii = 0 to bbcount
     	if len(trim(bb(ii) & " ")) <> 0 then
 ...
 <td bgcolor="#FFFFCC" class="plaintext" align="right" valign="top" width="92"><%
...
%>&nbsp;</td>
     <td bgcolor="#FFFFCC" class="plaintext" align="right" valign="top" width="93" ><%
