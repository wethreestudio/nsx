...
<div style="float:left;width:750px;">
  ...
  <div class="editarea">
    <h1>Edit Market Summary Alerts</h1>

	<form method="POST" action="user_market_summaries_save.asp">
	   <input type="hidden" id="returnurl" name="returnurl" value="company_market_summaries.asp">
		<% 
...
%>
  ...
  <p>Test your SMS and Email connections: <a href="user_test.asp?pss=nsxa&return=company_market_summaries.asp">Start Test Now</a> 
<%
		if session("errmsg")<>"OK" then
		  response.write "<br><font color=red size=1 face=arial><b>" & session("errmsg") & "</b></font>"
		else
