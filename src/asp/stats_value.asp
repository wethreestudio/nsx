...
<table cellspacing=0 border="0" width="165" id="table100" cellpadding="5" >
	<tr>
		<td class=plaintext bgcolor=#959CA0><font color="#FFFFFF"><b>Value</b></font></td>
...
ELSE
  ...
  <tr bgcolor="<%=cl(lap)%>" onMouseOver="this.bgColor='#CCCCDD'" onmouseout="this.bgColor='<%=cl(lap)%>'">
		...
		<td class=plaintext align=right><font size="1" color=<%=colr%>><%=formatnumber(value,0)%></font></td>
	</tr>
