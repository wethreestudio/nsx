...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="textheader" bgcolor="#FFFFFF" >
		...
		<h1><font face="Arial">END OF MONTH STATISTICS&nbsp;- SPSE</font></b></h1>
...
SQL = SQL & " WHERE (exchid='SEQY' or exchid='SBND' or exchid='SRST')"
...
%>
	...
	<p>Page:
      <%if currentpage > 1 then %>
                <a href="market_eom_spse.asp?nsxcode=<%=nsxcodes%>&currentpage=<%=currentpage-1%>">
	<font face="Arial">&lt;&lt;</font></a><a href="market_eom_spse.asp?nsxcodes=<%=nsxcodes%>&currentpage=<%=currentpage-1%>"> Previous <%=maxpagesize%></a> | 
            <%end if%>
      ...
      %>
      <a href="market_eom_spse.asp?nsxcodes=<%=nsxcodes%>&currentpage=<%=ii%>" ><%=ii%></a> | 
