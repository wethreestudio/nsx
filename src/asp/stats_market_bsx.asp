...
SQL = "SELECT TOP 10 DATEPART(Year, TradeDate), SUM(CASE WHEN AddDelete='D' THEN SaleVolume*-1 ELSE SaleVolume END),  SUM(CASE WHEN AddDelete='D' THEN SaleValue*-1 ELSE SaleValue END), Count(PricesTrades.prid), SUM(CASE WHEN AddDelete='D' THEN 1 ELSE 0 END) "
