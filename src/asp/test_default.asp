...
<div class="table-responsive"><table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="plaintext" bgcolor="#FFFFFF" colspan="3" align="center"><!--#INCLUDE FILE="ticker2.asp"--></td>
  </tr>
  <tr>
...
End Function
--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" name="FrontPage_Form2" action="http://svc021.wic003pa.server-web.com/member_pass.asp" style="margin-top: 0; margin-bottom: 0" language="JavaScript">
...
<div class="table-responsive"><table border="1" width="100%" id="table13" cellspacing="0" cellpadding="0" >
	<tr>
		...
		In line with the change of name of the market, the official NSX website 
		will move to <a href="<%= Application("nsx_SiteRootURL") %>">www.nsxa.com.au</a> 
		effective Monday 29th January 2007.&nbsp; This website will redirect to 
...
<h2><map name="FPMap0">
<area href="why_list.asp" shape="rect" coords="0, 0, 93, 62">
<area href="contacts.asp" shape="polygon" coords="120, 6, 163, 55, 189, 46, 141, 7, 124, 7">
<area coords="169, 152, 184, 58, 199, 97, 194, 152" shape="polygon" href="whatisa_NominatedAdviser.asp">
<area href="how_to_list.asp" shape="polygon" coords="57, 193, 62, 171, 172, 160, 161, 189">
<area href="market_officiallist.asp" shape="polygon" coords="28, 76, 33, 119, 132, 116, 126, 76">
</map>
<img border="0" src="images/badge/nsx_badge200.jpg" width="200" height="200" align="right" usemap="#FPMap0" alt="The NSX Journey">Why List?</h2>
...
<p align="justify">NSX Nominated Advisors assist companies through the listing process and with 
...
<br>
<font size="1"><a href="news_list.asp">More News</a> | Subscribe to feed: </font>
...
<font size="1">| <a href="whatis_rss.asp">What is RSS?</a> </font><p>&nbsp;</td>
  ...
  <div class="table-responsive"><table border="0" cellpadding="4" style="border-collapse: collapse" width="100%">
	...
	<tr>
		<td width=100% class=plaintext valign="top">
		<p align="left">
		<a target="main" class="mnlinks" href="stats_advances.asp">adv</a> | 
		<a target="main" class="mnlinks" href="stats_declines.asp">dec</a> 
		| <a target="main" class="mnlinks" href="stats_volume.asp">vol</a> |
		<a target="main" class="mnlinks" href="stats_value.asp">val</a> |
		<a href="stats_market.asp" target="main" class=mnlinks>mkt</a> | 
		<a target="main" class="mnlinks" href="stats_general.asp">gen</a> <br>
    ...
    <tr>
      ...
      <div class="table-responsive"><table cellpadding="0" style="border-collapse: collapse;" width="90%" id="table5">
        ...
        <tr>
          <td width="100%" class="plaintext">
      <p style="margin-top: 5px; margin-bottom: 5px">
      <font size="1"><a href="announcements_list.asp">More Announcements</a> | 
		Subscribe to feed: </font>
