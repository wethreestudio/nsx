...
<div class="editarea">
    <div style="padding-bottom:20px;">
	    <form action="partner_list_public.asp?" method="get" id="category_select">
<%
...
Else
	...
	selected = ""
	selecturl = server.HTMLencode("page=" & page & "&menu=" & menu & "&q")
	selecturl = "q"
%>
<label for="category">Filter results by</label>&nbsp;<select id="category" name="<%=selecturl%>" class="autosubmit">
...
%>
	...
	For i = 0 To clist1.count - 1
		cat_link = cat_link & "<a href='/partner_list_public.asp?" & page=" & page & "&menu=" & menu & "&q=" & clist1.getKey(i) & "'"" alt="""  & clist1.getByIndex(i) & """>"  & clist1.getByIndex(i) & "</a>,&nbsp;"
	Next
...
%>
	...
	For i = 0 To clist2.count - 1
		cat_link = cat_link & "<a href='partner_list_public.asp?page=" & page & "&menu=" & menu & "&q=" & server.urlencode(clist2.getKey(i)) & "'"" alt="""  & clist2.getByIndex(i) & """>"  & clist2.getByIndex(i) & "</a>,&nbsp;"
	Next
	If Len(cat_link) > 0 Then
		cat_link = Left(cat_link, Len(cat_link) - Len(",&nbsp;"))
	Else
