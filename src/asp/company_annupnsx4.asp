...
<form method="POST" action="company_announcement_upload2.asp" name="theForm" id="theForm" enctype="multipart/form-data">
...
%> 
  ...
  <div class="input_container">
      <input name="annPriceSensitive" value="Yes" type="radio"> Yes
      <input name="annPriceSensitive" value="No" checked="" type="radio">No
  </div>
  ...
  <div class="input_container">
      <input name="anncopy" value="Yes" type="radio"> Yes
      <input name="annCopy" value="No" checked="" type="radio">No <br>
  </div>
